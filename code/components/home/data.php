...
$dosql = "SELECT COUNT(*) as do_count FROM ticket WHERE stat='open' AND dtm = '" . $data_option . "'";
...
$dcsql = "SELECT COUNT(*) as dc_count FROM ticket WHERE stat='closed' AND dtm = '" . $data_option . "'";
